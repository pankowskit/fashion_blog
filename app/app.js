var appCfg ={
    navRoutes:[        
        ...
        {navItem:true, path:"/collection",name:"Collection",view:"app/views/collection.html"},
        {navItem:true, path:"/newsletter",name:"Newsletter",view:"app/views/newsletter.html"},
